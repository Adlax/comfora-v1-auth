...
const CartItem = ({ id, image, name, color, price, amount }) => {
	const { removeFromCartAction, toggleAmountAction } = useCartContext();

	const increaseAmount = () => {
		toggleAmountAction(id, "increase");
	};

	const decreaseAmount = () => {
		toggleAmountAction(id, "decrease");
	};
	...
	return (
		<Wrapper>
			...
			<button type="button" className="remove-btn" onClick={() => removeFromCartAction(id)}>
				{" "}
				<FaTrash />
			</button>
		</Wrapper>

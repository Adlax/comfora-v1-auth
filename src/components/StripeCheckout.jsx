...
const CheckoutForm = () => {
	const { cart, totalAmount, clearCartAction, shippingFee } = useCartContext();
		...
		<div>
			{succeeded ? (
				...
				<article>
					...
					<p>Test Card (Fake) Number : 4242 4242 4242 4242</p>
				</article>
			)}
			<form action="" id="payment-form" onSubmit={handleSubmit}>
				<CardElement id="card-element" options={cardStyle} onChange={handleChange} />
				<button disabled={processing || disabled || succeeded} id="submit">
					<span id="button-text">{processing ? <div className="spinner" is="spinner"></div> : "Pay"}</span>
				</button>
				{error && (
